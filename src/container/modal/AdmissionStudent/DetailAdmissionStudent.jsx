// src/modal/DetailAdmissionStudent.jsx
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p>
                  ...
                  {singleAdmission?.student_info?.id}
                </p>
                <p>
                  <strong className="text-gray-600">Họ Tên:</strong>{" "}
                  {singleAdmission?.student_info?.fullname}
                </p>
                <p>
                  <strong className="text-gray-600">Giới Tính:</strong>{" "}
                  {singleAdmission?.student_info?.gender ? "Nam" : "Nữ"}
                </p>
                <p>
                  <strong className="text-gray-600">Ngày Sinh:</strong>{" "}
                  {singleAdmission?.student_info?.date_of_birth}
                </p>
                <p>
                  <strong className="text-gray-600">CMND/CCCD:</strong>{" "}
                  {singleAdmission?.student_info?.citizen_id}
                </p>
                <p>
                  <strong className="text-gray-600">Email:</strong>{" "}
                  {singleAdmission?.student_info?.email}
                </p>
                <p>
                  <strong className="text-gray-600">Số Điện Thoại:</strong>{" "}
                  {singleAdmission?.student_info?.phone}
                </p>
                <p>
                  <strong className="text-gray-600">Địa Chỉ:</strong>{" "}
                  {singleAdmission?.student_info?.address}
                </p>
                <p>
                  <strong className="text-gray-600">Thành Phố:</strong>{" "}
                  {singleAdmission?.student_info?.city}
                </p>
                <p>
                  <strong className="text-gray-600">Trường THPT:</strong>{" "}
                  {singleAdmission?.student_info?.high_school}
                </p>
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-700">
                ...
                <p>
                  <strong className="text-gray-600">Ngành Học:</strong>{" "}
                  {singleAdmission?.major_name}
                </p>
                <p>
                  <strong className="text-gray-600">Trình Độ Học Vấn:</strong>{" "}
                  {singleAdmission?.academic_level_name}
                </p>
                <p>
                  <strong className="text-gray-600">Khối Thi:</strong>{" "}
                  {singleAdmission?.college_exam_group_name} (
                  {singleAdmission?.college_exam_group_code})
                </p>
                <p>
                  <strong className="text-gray-600">
                    Phương Thức Xét Tuyển:
                  </strong>{" "}
                  {singleAdmission?.evaluation_method_name}
                </p>
                <p>
                  <strong className="text-gray-600">Điểm Tổng Kết:</strong>{" "}
                  {singleAdmission?.final_score}
                </p>
                <p>
                  <strong className="text-gray-600">Kết Quả:</strong>{" "}
                  {singleAdmission?.is_passed ? "Đậu" : "Rớt"}
                </p>
              </div>
            </div>
            {renderSubjectScores()}
